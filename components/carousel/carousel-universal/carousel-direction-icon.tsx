...
type WaveDirectionProps = {
  direction: number;
  size?: number;
};

/* Calcuates which direction to display the directional Icon*/
...
/* Displays a directional icon based on passed prop*/
const LargeInfoWaveDirection: React.FC<WaveDirectionProps> = ({ direction, size = 40 }) => {
...
export default LargeInfoWaveDirection;
