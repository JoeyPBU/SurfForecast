...
/* Calculates the cardinal direction of the wind based on passed props */
...
/* Displays the Icon based on the direction of the wind */
const LargeInfoCardWindDirection: React.FC<WindDirectionProps> = ({ direction, size = 30 }) => {
...
export default LargeInfoCardWindDirection;
